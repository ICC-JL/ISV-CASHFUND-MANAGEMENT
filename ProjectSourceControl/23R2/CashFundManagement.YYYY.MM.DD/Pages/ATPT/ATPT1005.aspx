...
Try to change filter to see records here." />
                        <levels>
                            <px:pxgridlevel datamember="FundsApproval">
                                ...
                                <columns>
                                    ...
                                    <px:pxgridcolumn datafield="AssignmentMapID" width="180px" textalign="Left" textfield="AssignmentMapID_EPAssignmentMap_Name">
                                    </px:pxgridcolumn>
                    ...
                    <px:pxgrid id="gridFundTransactionRequestApproval" runat="server" datasourceid="ds" skinid="DetailsInTab" width="100%" height="300px">
                        <emptymsg anonfilteredaddmessage="No records found.
Try to change filter to see records here."
                            anonfilteredmessage="No records found.
Try to change filter to see records here."
...
Try to change filter to see records here." />
                    ...
                    <px:pxgrid id="gridReplenishmentRequestApproval" runat="server" datasourceid="ds" skinid="DetailsInTab" width="100%" height="300px">
                        <emptymsg anonfilteredaddmessage="No records found.
Try to change filter to see records here."
                            anonfilteredmessage="No records found.
Try to change filter to see records here."
...
Try to change filter to see records here." />
                    ...
                    <px:pxgrid id="gridMonthEndRequestApproval" runat="server" datasourceid="ds" skinid="DetailsInTab" width="100%" height="300px">
                        <emptymsg anonfilteredaddmessage="No records found.
Try to change filter to see records here."
                            anonfilteredmessage="No records found.
Try to change filter to see records here."
