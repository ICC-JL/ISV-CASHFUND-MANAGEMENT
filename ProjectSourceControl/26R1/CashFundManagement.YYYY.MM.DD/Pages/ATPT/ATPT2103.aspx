<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="ATPT2103.aspx.cs" Inherits="Page_ATPT2103" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="CashFundManagement.BLC.ATPTEFMReplenishmentMaint" PrimaryView="Filter">
        <CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" SkinID="PrimaryInquire" SyncPosition="True" KeepPosition="True" FastFilterFields="ReplenishmentNbr,Descr" TabIndex="5700">
...
Try to change filter to see records here."></EmptyMsg>
        <Levels>
            <px:PXGridLevel DataMember="Replenishment" DataKeyNames="FundType,ReplenishmentNbr">


                <Columns>
                    <px:PXGridColumn DataField="Date" Width="90px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="ReplenishmentNbr" Width="140px" LinkCommand="EditDetail">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Status">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="FundID">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Descr" Width="280px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CustodianID" Width="140px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CustodianID_EPEmployee_acctName" Width="220px">
                    </px:PXGridColumn>
