<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="ATPT5016.aspx.cs" Inherits="Page_ATPT5016" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Summary" TypeName="CashFundManagement.BLC.ATPTEFMCAReclassProcess" >
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100"
		...
		<Levels>
			<px:PXGridLevel DataKeyNames="CashAdvanceNbr" DataMember="Summary">
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="CashAdvanceNbr" Width="140px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Descr" Width="280px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="RequestedByID_description" Width="280px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CuryChangeAmount" Width="100px" TextAlign="Right">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CuryID" Width="90px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="LiqDate" Width="100px">
                    </px:PXGridColumn>
                </Columns>
			</px:PXGridLevel>
		</Levels>
